...
namespace SharpUnit
{
    public class Assert
    {
        ...
        public static void ExpectException<T>() where T : Exception, new()
        {
            ms_exception = new T();
        }
        ...
        public static void Equal(uint wanted, uint got)
        {
            // If values not equal
            if (wanted != got)
            {
        ...
        public static void Equal(uint wanted, uint got, string msg)
        {
            // If values not equal
            if (wanted != got)
            {
        ...
        public static void Equal(IntPtr wanted, IntPtr got)
        {
            // If values not equal
            if (wanted != got)
            {
        ...
        public static void Equal(UIntPtr wanted, UIntPtr got)
        {
            // If values not equal
            if (wanted != got)
            {
        ...
        public static unsafe void Equal(int* wanted, int* got)
        {
            // If values not equal
            if (wanted != got)
            {
                // Test failed
                throw new TestException("Expected " + new IntPtr(wanted) + ", Got " + new IntPtr(got));
            }
        }

        public static void Equal(long wanted, long got)
        {
            // If values not equal
            if (wanted != got)
            {
        ...
        public static void Equal(long wanted, long got, string msg)
        {
            // If values not equal
            if (wanted != got)
            {
        ...
        public static void Equal(ulong wanted, ulong got)
        {
            // If values not equal
            if (wanted != got)
            {
        ...
        public static void Equal(ulong wanted, ulong got, string msg)
        {
            // If values not equal
            if (wanted != got)
            {
        ...
        {
            if (float.IsNaN(wanted) && float.IsNaN(got))
            {
                return;
            }
            // If values not equal
        ...
        public static void Equal(double wanted, double got)
        {
        ...
        public static void Equal(double wanted, double got, string msg)
        {
            if (wanted != got)
            {
                // Test failed
