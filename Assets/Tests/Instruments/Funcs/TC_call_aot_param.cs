...
namespace Tests.Instruments.Funcs
{
    ...
    internal class TC_call_aot_param : GeneralTestCaseBase
    {
        ...
        public void vector2()
        {
            Assert.Equal(3f, TestAOTParam.HFA_Vector2_ReturnParam(new UnityEngine.Vector2(1f, 2f)));
        }

        [UnitTest]
        public void vector3()
        {
            Assert.Equal(6f, TestAOTParam.HFA_Vector3_ReturnParam(new UnityEngine.Vector3(1f, 2f, 3f)));
        }

        [UnitTest]
        public void vector4()
        {
            Assert.Equal(10f, TestAOTParam.HFA_Vector4_ReturnParam(new UnityEngine.Vector4(1f, 2f, 3f, 4f)));
        }

        [UnitTest]
        public void embedHFA()
        {
            var a = TestAOTParam.EmbedHFA_ReturnParam(new EmbedHFA { x = new UnityEngine.Vector2(1f, 10f), y = 100f });
            Assert.Equal(111f, a);
        }
        ...
        {
            var a = TestAOTParam.EmbedHFA2_ReturnParam(new EmbedHFA2 { x = new UnityEngine.Vector2(1f, 10f), y = new UnityEngine.Vector2(100f, 1000f) });
